...
ela.plot_emline(1, 10, color="m")
ela.plot_emline(2, 10, color="m")
ela.plot_emline(3, 10, color="m")
ela.plot_emline(4, 10, color="m")
ela.plot_emline(2, 11, color="m")

ela.zlevels = np.concatenate((ela.zlevels, [68]), axis=0)
ela.plot_emline(6, 1, color="y")
